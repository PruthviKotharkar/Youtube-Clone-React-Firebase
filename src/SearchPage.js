...
function SearchPage() {
    return (
        <div className="searchPage">
            ...
            <ChannelRow
            image="https://avatars.githubusercontent.com/u/80215426?s=60&v=4"
            channel="Coder OP"
            verified
            subs="12K"
            noOfVideos={20}
            description="Programming In the Blood | Married to ReactJs | Dating Javascript"
            />
            <hr/>
            ...
            image="https://i.ytimg.com/vi/QubElT1WDeY/hq720.jpg?sqp=-oaymwEcCOgCEMoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBDy3jhENM0Rbyu1pdJZvhHhObajA"
            />
